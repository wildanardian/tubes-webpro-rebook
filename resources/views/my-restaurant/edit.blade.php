...
@section('content')
    <div class="container mt-5">
        <div class="shadow p-3 mb-5 bg-white rounded" style="height: 88%;">
            <p class="text-center fw-bold" style=" font-size: 30px;">Edit My Restaurant</p>
            <hr class="mt-3" style="width: 99%">

            <form action="{{ route('my-restaurant.update', ['id' => $restaurant->id]) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="" cols="28" rows="5" name="description"
                                ...
                                style="resize: none; border-radius: 8px; width: 95%; height: 145px;" placeholder="Restaurant Description">{{ old('description', $restaurant->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="" cols="28" rows="5" name="address"
                                ...
                                style="resize: none; width: 95%; height: 145px; border-radius: 8px;" placeholder="Restaurant Address">{{ old('address', $restaurant->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="mb-2 d-flex">
                                <div class="flex-column">
                                    <select class="me-2 @error('opening_day_from') is-invalid @enderror" value=""
                                        ...
                                        @foreach ($restaurant_day as $day)
                                            <option value="{{ $day }}"
                                                {{ old('opening_day_from', $restaurant->opening_day_from) == $day ? 'selected' : '' }}>
                                                {{ $day }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="flex-column">
                                    <select class="ms-2 @error('opening_day_to') is-invalid @enderror" name="opening_day_to"
                                        ...
                                        @foreach ($restaurant_day as $day)
                                            <option value="{{ $day }}"
                                                {{ old('opening_day_to', $restaurant->opening_day_to) == $day ? 'selected' : '' }}>
                                                {{ $day }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-2" style="display: inline-flex;">
                                <div class="flex-column">
                                    <select class="me-2 @error('opening_hour_from') is-invalid @enderror "
                                        ...
                                        @foreach ($restaurant_hour as $hour)
                                            <option value="{{ $hour }}"
                                                {{ old('opening_hour_from', $restaurant->opening_hour_from) == $hour ? 'selected' : '' }}>
                                                {{ $hour }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="flex-column">
                                    <select class="ms-2 @error('opening_hour_to') is-invalid @enderror"
                                        ...
                                        @foreach ($restaurant_hour as $hour)
                                            <option value="{{ $hour }}"
                                                {{ old('opening_hour_to', $restaurant->opening_hour_to) == $hour ? 'selected' : '' }}>
                                                {{ $hour }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                ...
                                id="contact" name="contact" value="{{ old('contact', $restaurant->contact) }}"
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('my-restaurant.index') }}" class="btn btn-danger me-3">Cancel</a>
                        <input type="submit" class="btn btn-success " style="width: 15%;" value="Update Restaurant">
